...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    <div class="sm:flex sm:items-center">
        <div class="sm:flex-auto">
            <h1 class="text-2xl font-semibold text-gray-900">Rastrear Pedidos</h1>
            <p class="mt-2 text-sm text-gray-700">Seguimiento de pedidos activos y en ruta.</p>
        </div>
                    ...
                    <table class="min-w-full divide-y divide-gray-300">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">Ruta Asignada</th>
                            </tr>
                        </thead>
                            ...
                            <tr>
                                ...
                                <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                    <span class="inline-flex rounded-full px-2 text-xs font-semibold leading-5 
                                        {{ $order->estado === 'asignado' ? 'bg-yellow-100 text-yellow-800' : 'bg-blue-100 text-blue-800' }}">

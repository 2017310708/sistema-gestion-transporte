...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    <div class="max-w-3xl mx-auto">
        ...
        <form action="{{ route('admin.drivers.update', $driver) }}" method="POST" class="mt-8 space-y-6">
            @csrf
            @method('PUT')
                ...
                <div class="px-4 py-5 sm:p-6">
                    <div class="grid grid-cols-1 gap-6">
                        <div class="col-span-1">
                            ...
                            <input type="text" name="nombre" id="nombre" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="{{ old('nombre', $driver->user->nombre) }}" required>
                            @error('nombre')
                        ...
                        <div class="col-span-1">
                            ...
                            <input type="text" name="apellido_paterno" id="apellido_paterno" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="{{ old('apellido_paterno', $driver->user->apellido_paterno) }}" required>
                        ...
                        <div class="col-span-1">
                            ...
                            <input type="text" name="apellido_materno" id="apellido_materno" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="{{ old('apellido_materno', $driver->user->apellido_materno) }}" required>
                        ...
                        <div class="col-span-1">
                            ...
                            <input type="email" name="email" id="email" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="{{ old('email', $driver->user->email) }}" required>
                            @error('email')
                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="col-span-1">
                            ...
                            <input type="tel" name="telefono" id="telefono" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="{{ old('telefono', $driver->telefono) }}" required>
                            @error('telefono')
                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="col-span-1">
                            ...
                            <select name="estado" id="estado" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" required>
                                ...
                                <option value="en_ruta" {{ old('estado', $driver->estado) == 'en_ruta' ? 'selected' : '' }}>En Ruta</option>

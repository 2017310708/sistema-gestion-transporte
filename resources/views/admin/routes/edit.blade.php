...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    <div class="max-w-3xl mx-auto">
        ...
        <form action="{{ route('admin.routes.update', $route) }}" method="POST" class="mt-8 space-y-6">
            @csrf
            @method('PUT')
                ...
                <div class="px-4 py-5 sm:p-6">
                    <div class="grid grid-cols-1 gap-6">
                        <div class="col-span-1">
                            ...
                            <input type="text" name="origen" id="origen" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="{{ old('origen', $route->origen) }}" required>
                            @error('origen')
                        ...
                        <div class="col-span-1">
                            ...
                            <input type="text" name="destino" id="destino" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="{{ old('destino', $route->destino) }}" required>
                            @error('destino')
                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="col-span-1">
                            ...
                            <input type="datetime-local" name="fecha_salida" id="fecha_salida" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="{{ old('fecha_salida', $route->fecha_salida ? date('Y-m-d\TH:i', strtotime($route->fecha_salida)) : '') }}" required>
                            @error('fecha_salida')
                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="col-span-1">
                            ...
                            <input type="datetime-local" name="fecha_llegada" id="fecha_llegada" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="{{ old('fecha_llegada', $route->fecha_llegada ? date('Y-m-d\TH:i', strtotime($route->fecha_llegada)) : '') }}" required>
                            @error('fecha_llegada')
                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="col-span-1">
                            ...
                            <textarea name="descripcion" id="descripcion" rows="3" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">{{ old('descripcion', $route->descripcion) }}</textarea>
                            @error('descripcion')
                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>

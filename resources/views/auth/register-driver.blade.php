...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-md mx-auto bg-white rounded-lg shadow-lg p-6">
        <h2 class="text-2xl font-bold text-center mb-6">Registro de Conductor</h2>
        ...
        <form method="POST" action="{{ route('register.driver') }}" class="space-y-4">
            @csrf
            ...
            <div>
                ...
                <input type="text" name="dni" id="dni" value="{{ old('dni') }}" required maxlength="8" pattern="[0-9]{8}"
                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                @error('dni')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
